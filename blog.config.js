...
const BLOG = {
  ...
  AUTHOR: 'Lurnen', // 作者
  BIO: '兔兔琐琐！！是可爱的兔兔捏！<br/>B站：流濯Lumen', // 作者简介
  LINK: 'https://tangly1024.com', // 网站地址
  KEYWORDS: 'Notion, 博客, 流濯', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'enenoazi@outlook.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/Lumen1437', // 你的github个人主页
